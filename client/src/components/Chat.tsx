...
// const Chat = ({ socket, username, room, setShowChat }: Props) => {
...
//   const notifyViewedMessages = useCallback(() => {
//     messageList.forEach((message) => {
//       console.log('message.id',message.id);
//       console.log('socket.id',socket.id);
//       if (message.status === 'sent' && message.id !== socket.id) {
...
//       // Отправляем событие, чтобы отметить, что сообщение просмотрено
//       socket.emit('message_viewed', { id: data.id, room });
//     });
...
//     };
//   }, [socket, room,notifyViewedMessages]);

//     // Получение сообщений от других пользователей
//   // useEffect(() => {
//   //   socket.on('receive_message', (data: Message) => {
//   //     console.log('data0');
//   //     setMessageList((prev) => [...prev, { ...data, status: 'viewed' }]);
//   //   });
//   //   notifyViewedMessages();
...
//   //     socket.off('status_updated');
//   //   };
//   // }, [notifyViewedMessages, socket]);

//   // Функция для отображения иконки статуса
//   const getStatusIcon = (status: string | undefined) => {
//     switch (status) {
//       case 'sent':
//         return <DoneAllIcon />; // Две галочки
//       case 'viewed':
//         return <DoneAllIcon color='primary' />; // Две синие галочки
//       default:
//         return null;
//     }
//   };
